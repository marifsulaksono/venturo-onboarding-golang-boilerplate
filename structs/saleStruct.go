...
type Sale struct {
	...
	Customer   *CustomerResponse `json:"customer,omitempty" gorm:"-:migration;foreignKey:CustomerID;references:ID"`
...
type SaleDetail struct {
	...
	Product         *ProductResponse `json:"product" gorm:"-:migration;foreignKey:ProductID;references:ID"`
